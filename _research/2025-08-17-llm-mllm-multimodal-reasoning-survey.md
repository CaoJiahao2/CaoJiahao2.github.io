---
title: "大型多模态推理模型（LMRM）综述"
description: "论文：**Perception, Reason, Think, and Plan: A Survey on Large Multimodal Reasoning Models"
date: 2025-08-17
tags: [深度学习, 科研笔记, 大模型, LLM, MLLM, 推理, 多模态]
layout: single
author_profile: true
share: true
toc: true
