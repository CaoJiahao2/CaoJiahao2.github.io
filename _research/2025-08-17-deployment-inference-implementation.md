---
title: "大模型推理实现详解：从 Transformer Forward 到高性能 Serving"
description: "本文从系统实现视角解释现代大语言模型（LLM）推理是如何完成的，重点覆盖 Prefill、Decode、KV Cache、Continuous Batching、PagedAttention、FlashAttention、Speculative Decoding、量化、多 GPU 并行、MoE 推理和 Prefill-Decode 解耦等核心机制。"
date: 2025-08-17
tags: [深度学习, 科研笔记, 模型部署, 推理优化, Transformer, 推理]
layout: single
author_profile: true
share: true
toc: true
